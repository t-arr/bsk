...
class TestBowlingGame(unittest.TestCase):
    ...
    def test_calculate_strike_spare(self):
        game = BowlingGame()
        game.add_frame(Frame(10, 0))
    ...
    def test_calculate_strike_followed_by_strike(self):
        game = BowlingGame()
        game.add_frame(Frame(10, 0))
        game.add_frame(Frame(10, 0))
        game.add_frame(Frame(7, 2))
    ...
    def test_calculate_spare_followed_by_spare(self):
        game = BowlingGame()
    ...
    def test_calculate_last_frame_spare(self):
        game = BowlingGame()
        game.add_frame(Frame(1, 5))
        game.add_frame(Frame(3, 6))
        game.add_frame(Frame(7, 2))
    ...
    def test_calculate_last_frame_strike(self):
        game = BowlingGame()
        game.add_frame(Frame(1, 5))
        game.add_frame(Frame(3, 6))
        game.add_frame(Frame(7, 2))
    ...
    def test_calculate_last_two_frames_strike(self):
        game = BowlingGame()
        game.add_frame(Frame(1, 5))
        game.add_frame(Frame(3, 6))
        game.add_frame(Frame(7, 2))
